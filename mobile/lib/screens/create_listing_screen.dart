...
class _CreateListingScreenState extends State<CreateListingScreen> {
  ...
  Future<void> _submitData() async {
    ...
    try {
      ...
      final data = {
        ...
        'price': _listingType == 'sahiplendirme' ? '0' : _priceController.text.trim(),
        'breed': _breed ?? '',
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Text(isLastStep ? 'İlanı Yayınla' : 'Devam Et', style: const TextStyle(fontSize: 16)),
                            ),
                          ),
  ...
  Widget _buildStep1BasicInfo() {
    return Column(
      ...
      children: [
        const Text('Hayvan Kategorisi', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        ...
        Wrap(
          ...
          children: AppConstants.categoryAnimals.keys.map((cat) {
            ...
            return ChoiceChip(
              label: Text(cat[0].toUpperCase() + cat.substring(1), style: TextStyle(color: isSelected ? Colors.white : Colors.black87)),
              selected: isSelected,
        ...
        const SizedBox(height: 24),
        const Text('İlan Tipi', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 12),
        Wrap(
          spacing: 8,
          runSpacing: 8,
          children: ['satılık', 'sahiplendirme'].map((type) {
            ...
            return ChoiceChip(
              label: Text(type[0].toUpperCase() + type.substring(1), style: TextStyle(color: isSelected ? Colors.white : Colors.black87)),
              selected: isSelected,
              selectedColor: Colors.green[700],
              onSelected: (selected) {
  ...
  Widget _buildStep2Details() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        const Text('Yapılan Aşılar', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 12),
        Wrap(
          spacing: 8,
          runSpacing: 8,
              ...
              children: [
                ...
                if (_images.isEmpty)
                  const Padding(
                    ...
                    child: Text('En az 1 fotoğraf yüklemelisiniz', style: TextStyle(color: Colors.red, fontSize: 12)),
                  ),
              ],
            ),
          ),
